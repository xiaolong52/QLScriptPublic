 ...
 * 如果抓不到/无网络请在 api.jrkz66.com headers中找到Authorization的值,Cookie里找到third-app-token 的值和qianfan_device 的值
 * 请把qianfan_device的值base64转化后再去填入
 * 用&连接 举例 0a63TjN/KP...&Bearer eyJ..&Yz...cO== 变量触发条件(屏蔽VPN | wifi代理 | ROOT) => 首页左上角 头像
 * base64编码工具: https://c.runoob.com/front-end/693/
 * ====================================
 *   
 */
